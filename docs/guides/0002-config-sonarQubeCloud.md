...
1. Click to `Analyze new project`: ![Image - Add a project](../../images/0002-config-sonarQubeCloud/2026-05-28-17-09-34.png)
2. Select your repository: ![Image - Select the project](../../images/0002-config-sonarQubeCloud/2026-05-28-17-10-40.png)

## Step 3 - Create a Token

1. Go to `my acount`: ![Image - Go to my account](../../images/0002-config-sonarQubeCloud/2026-05-28-17-12-13.png)
2. Open the `Security` tab.
3. Generate a new Token: ![Image - Generate Token](../../images/0002-config-sonarQubeCloud/2026-05-28-17-14-43.png)
