...
Welcome to the documentation 📜 ! Here's how it's organized :

- [/architecture](./architecture/) : Global diagrams.
- [/adr](./adr) : History of important technical decisions.
- [api](../apps/backend/api/openapi.yaml): API's documentation
